...
namespace Ex03.GarageLogic
{
    internal class Car : Vehicle
    {
        ...
        public Car(string i_ModelName, string i_LicenseNumber, float i_CurrentEnergy, float i_EngineCapcity, eCarColor i_CarColor, eNumOfDoors i_NumOfDoors, int i_CurrentAirPresure)
        ...
        public Car(string i_ModelName, string i_LicenseNumber, float i_CurrentEnergy, float i_EngineCapcity, eFuelType i_FuelType, eCarColor i_CarColor, eNumOfDoors i_NumOfDoors, int i_CurrentAirPresure)
